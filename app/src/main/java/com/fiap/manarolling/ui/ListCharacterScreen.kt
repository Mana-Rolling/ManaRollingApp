...
// ⬇️ Opt-in necessário para TopAppBar na sua versão do M3
        ...
        if (list.isEmpty()) {
            Box(
                ...
                Column(horizontalAlignment = Alignment.CenterHorizontally) {
                    ...
                    Text("Nenhum personagem", style = MaterialTheme.typography.titleMedium)
                ...
                items(list) { c ->
                    ElevatedCard(
                        ...
                        Row(
                            ...
                            Text(c.avatarEmoji, style = MaterialTheme.typography.headlineSmall)
                            ...
                            Column(Modifier.weight(1f)) {
                                ...
                                Text(
                                    text = "Classe: ${c.clazz.ifBlank { "-" }} • Nível ${c.level}",
